...
export function RequestPasswordReset() {
  ...
  return (
    <div className="max-w-sm border-t border-gray-100 pt-4">
      <p className="text-sm font-semibold text-[#0b1b62]">Forgot your current password?</p>
      ...
      {confirming ? (
        <div className="mt-3 rounded-lg bg-amber-50 p-3">
          ...
          <div className="mt-2 flex gap-2">
            <button
              ...
              className="flex-1 rounded-lg border border-gray-300 py-2 text-xs font-semibold text-gray-700 hover:bg-gray-50 disabled:opacity-60"
            >
              Cancel
            </button>
            <button
        ...
        <button
          ...
          className="mt-3 flex items-center gap-2 rounded-lg border border-slate-200 px-4 py-2 text-sm font-semibold text-[#0b1b62] hover:bg-gray-50"
        >
