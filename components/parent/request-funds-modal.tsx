...
import { requestWalletFunds } from '@/app/parent/payments/actions'

export function RequestFundsModal({ onClose }: { onClose: () => void }) {
    ...
    <Modal onClose={onClose} maxWidth="md">
      <div className="border-b border-gray-100 dark:border-gray-800 p-6">
        <div className="flex items-start justify-between">
          <h2 className="text-xl font-bold text-gray-900 dark:text-gray-100">Add Funds</h2>
          <button onClick={onClose} aria-label="Close" className="text-gray-400 dark:text-gray-500 hover:text-gray-600">
            <X className="h-5 w-5" />
          </button>
        </div>
        <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">
          Requests are reviewed by the school and credited to your wallet once approved.
        </p>
      </div>
          ...
          <div className="space-y-3">
            ...
            <div>
              ...
              <input
                ...
                placeholder="e.g. Topping up for this month's tuition"
