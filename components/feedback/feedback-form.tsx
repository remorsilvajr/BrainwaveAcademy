...
// The actual submission form — shared by BugReportModal (wraps this in Modal
// chrome, passes its own onClose as onCancel) and the sidebar Feedback page's
      ...
      <div className="p-6">
        {sent ? (
          ...
          <>
            ...
            <label className="mb-1 block text-sm font-semibold text-[#0b1b62] dark:text-indigo-300">Subject</label>
            <input
              value={subject}
