      ...
      <main className="flex-1 px-4 py-12">
        <div className="mx-auto max-w-3xl">
          <div className="mb-8 text-center">
            <h1 className="text-4xl font-bold text-[#0b1b62]">Student Enrollment Application</h1>
            <p className="mt-3 text-base text-[#454650]">
          ...
          {submitted ? (
            <div className="rounded-xl border border-[#c6c5d2] bg-white p-8 text-center shadow-sm">
              <h2 className="text-2xl font-semibold text-[#0b1b62]">Application Submitted!</h2>
