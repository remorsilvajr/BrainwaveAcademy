...
| `npm run test:integration` | `tests/integration/`: real RLS and wallet checks with signed-in throwaway accounts. | Yes, writes to the live Supabase project, cleans up |
